...
def compute_errors(gt, pred, dataset):
    ...
    if count < 1:
        a1 = a2 = a3 = 1.0
        return [abs_diff, abs_rel, sq_rel, log10, rmse, rmse_log, a1, a2, a3]

    return [metric.item() / count for metric in [abs_diff, abs_rel, sq_rel, log10, rmse, rmse_log, a1, a2, a3]]
